 ...
 */
public class M5ViewDragHelper {
    private static final String TAG = "M5ViewDragHelper";
     ...
     * @return a new ViewDragHelper instance
     */
    public static M5ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final M5ViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private M5ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant " +
                    "of the M5ViewDragHelper's tracked parent view (" + mParentView + ")");
        }
